...
function renderInitialCard(array) {
  ...
  card.querySelector('.elements__photo').src = array.link;
  card.querySelector('.elements__photo').alt = array.name;
  card.querySelector('.elements__title').textContent = array.name;
